...
const FAKE_SIGNUPS = [
  ...
  { name: 'Michael', location: 'Los Angeles', time: '22 min ago', plan: 'Pro' },
  { name: 'Anna', location: 'Stockholm', time: '25 min ago', plan: 'Agency' },
  { name: 'David', location: 'Chicago', time: '28 min ago', plan: 'Starter' },
  { name: 'Elena', location: 'Madrid', time: '30 min ago', plan: 'Pro' },
  { name: 'Hassan', location: 'Cairo', time: '33 min ago', plan: 'Pro' },
  { name: 'Olivia', location: 'Melbourne', time: '35 min ago', plan: 'Starter' },
  { name: 'Lucas', location: 'Amsterdam', time: '38 min ago', plan: 'Agency' },
  { name: 'Mia', location: 'Singapore', time: '40 min ago', plan: 'Pro' },
  { name: 'Noah', location: 'Miami', time: '42 min ago', plan: 'Starter' },
  { name: 'Chloe', location: 'Vancouver', time: '45 min ago', plan: 'Pro' },
  { name: 'Liam', location: 'Dublin', time: '48 min ago', plan: 'Agency' },
  { name: 'Ava', location: 'Hong Kong', time: '50 min ago', plan: 'Pro' },
  { name: 'Ethan', location: 'Seattle', time: '53 min ago', plan: 'Starter' },
  { name: 'Isabella', location: 'Rome', time: '55 min ago', plan: 'Pro' },
  { name: 'Benjamin', location: 'Austin', time: '58 min ago', plan: 'Agency' },
  { name: 'Amelia', location: 'Copenhagen', time: '1 hour ago', plan: 'Pro' },
  { name: 'William', location: 'Denver', time: '1 hour ago', plan: 'Starter' },
  { name: 'Charlotte', location: 'Oslo', time: '1 hour ago', plan: 'Pro' },
  { name: 'Oliver', location: 'Barcelona', time: '1 hour ago', plan: 'Agency' },
  { name: 'Sophia', location: 'Zurich', time: '1 hour ago', plan: 'Pro' },
];
